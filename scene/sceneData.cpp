...
std::unique_ptr<SceneData> sceneFactory::createScene()
{
    ...
    girlModel->setPosition(Eigen::Vector3f(-1.0f, 2.0f, 6.0f));
    ...
    anmModel->setPosition(Eigen::Vector3f(0.0f, 2.0f, 6.0f));
    ...
    ironTeapotModel->setPosition(Eigen::Vector3f(0.0f, 20.0f, 0.0f));
    ...
    grassTeapotModel->setPosition(Eigen::Vector3f(0.0f, 100.0f, 0.0f));
