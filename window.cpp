...
void Window::update()
{
    ...
    if (cmd_moveForward_)
        static_cast<CameraCommand *>(cmd_moveForward_)->setDeltaTime(deltaTime_);
    if (cmd_moveBackward_)
        static_cast<CameraCommand *>(cmd_moveBackward_)->setDeltaTime(deltaTime_);
    if (cmd_moveLeft_)
        static_cast<CameraCommand *>(cmd_moveLeft_)->setDeltaTime(deltaTime_);
    if (cmd_moveRight_)
        static_cast<CameraCommand *>(cmd_moveRight_)->setDeltaTime(deltaTime_);
    if (cmd_moveUp_)
